...
<body>
  ...
  <main id="main">
    ...
    <section class="section category">
      <h2 class="title">THE BEST OF NIKE</h2>
      <button href="/Nike" class="btn-shop scrollto" >SHOP</button>
      <div class="category-center container">
        <div class="category-box" style="">
          <img src="./frontend/banner/banner_AIR1.jpg" alt="" style="">
          <div class="content">
            <h2>NIKE AIR FUTURE</h2>

            <a href="/Ghe">Shop now</a>
          </div>
        </div>

        <div class="category-box" style="">
          <img src="./frontend/banner/banner_JORDAN2.jpg" alt="">
          <div class="content">
            <h2>JORDAN </h2>

            <a href="/Ban">Shop now</a>
          </div>
        </div>

        <div class="category-box">
          <img src="./frontend/banner/banner_AF1.jpg" alt="" style="height: 27rem; padding: bottom 150px;">
          <div class="content">
            <h2>AIR FORCE 1</h2>
            <a href="/SOFA">Shop Now</a>
          </div>
        </div>
      </div>
    </section>
    <!-- trending Section -->
    <section class="section category" class="col-lg-12 d-flex justify-content-center">
      <h2 class="title">THE BEST OF NIKE</h2>
      <button href="/Trending" class="btn-shop scrollto" >SHOP</button>
      <div class="category-center container">
        <a href="/Trending"><img id="img_trend"src="./frontend/banner/banner_trend.jpg" alt="" ></a>
      </div>
    </section>
    <!-- ======= Product Section ======= -->
